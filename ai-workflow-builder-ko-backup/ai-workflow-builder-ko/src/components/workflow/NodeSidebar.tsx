...
import { Type, Bot, Wand2, FileOutput, GitBranch, Repeat, Globe, Timer, Bell, Shuffle, Scissors, Calendar, Download, ListTodo, Database, Route, UserCheck, StickyNote, Code2, GitMerge, FileText, Eraser, Calculator, Search, FunctionSquare, Filter, TrendingUp } from 'lucide-react';
import { useWorkflowStore } from '@/lib/stores/workflow-store';
import { InputNodeData, LLMNodeData, TransformNodeData, OutputNodeData, ConditionNodeData, LoopNodeData, ApiNodeData, DelayNodeData, WebhookNodeData, RandomNodeData, SliceNodeData, DateTimeNodeData, FileSaveNodeData, TaskBreakdownNodeData, StateNodeData, AIRouterNodeData, ApprovalNodeData, NoteNodeData, CodeNodeData, ParallelNodeData, TemplateNodeData, HtmlCleanNodeData, MathNodeData, FormulaNodeData, MultiFilterNodeData, StockAlertNodeData, WorkflowNodeData } from '@/types/workflow';
