...
const CONFIG_COMPONENTS: Record<NodeType, React.ComponentType<ConfigProps> | null> = {
  ...
  multiagent: MultiAgentConfig as React.ComponentType<ConfigProps>,
  compareinput: CompareInputConfig as React.ComponentType<ConfigProps>,
  tableoutput: TableOutputConfig as React.ComponentType<ConfigProps>,
  chart: ChartConfig as React.ComponentType<ConfigProps>,
  intentparser: IntentParserConfig as React.ComponentType<ConfigProps>,
  smartanalysis: null, // 설정 필요 없음 - 자동으로 다 처리
};
